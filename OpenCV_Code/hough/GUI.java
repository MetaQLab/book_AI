    ...
    protected void processOperation() {
        ...
        if(circularHoughString.equals(operation)){
            ...
            for( int i = 0; i < lines.cols(); i++ )
            {
              ...
              Imgproc.line( image, pt1, pt2, new Scalar(255,0,0), 2, 16, 0);
            }
        ...
        for( int i = 0; i < lines.cols(); i++ )
        {
            ...
            Imgproc.line( image, new Point(a, b), new Point(c, d), new Scalar(0,0,255), 1, 16, 0);
